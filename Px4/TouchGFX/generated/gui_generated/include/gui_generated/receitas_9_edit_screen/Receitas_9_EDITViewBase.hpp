...
/*********************************************************************************/
#ifndef RECEITAS_9_EDITVIEWBASE_HPP
#define RECEITAS_9_EDITVIEWBASE_HPP
...
class Receitas_9_EDITViewBase : public touchgfx::View<Receitas_9_EDITPresenter>
{
public:
    Receitas_9_EDITViewBase();
    virtual ~Receitas_9_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_9_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_9_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_9_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_9_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_9_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_9_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_9_EDITVIEWBASE_HPP
