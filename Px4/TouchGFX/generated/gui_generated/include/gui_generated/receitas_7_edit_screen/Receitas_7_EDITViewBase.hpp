...
/*********************************************************************************/
#ifndef RECEITAS_7_EDITVIEWBASE_HPP
#define RECEITAS_7_EDITVIEWBASE_HPP
...
class Receitas_7_EDITViewBase : public touchgfx::View<Receitas_7_EDITPresenter>
{
public:
    Receitas_7_EDITViewBase();
    virtual ~Receitas_7_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_7_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_7_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_7_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_7_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_7_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_7_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_7_EDITVIEWBASE_HPP
