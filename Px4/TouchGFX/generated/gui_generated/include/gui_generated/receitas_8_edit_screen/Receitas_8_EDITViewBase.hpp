...
/*********************************************************************************/
#ifndef RECEITAS_8_EDITVIEWBASE_HPP
#define RECEITAS_8_EDITVIEWBASE_HPP
...
class Receitas_8_EDITViewBase : public touchgfx::View<Receitas_8_EDITPresenter>
{
public:
    Receitas_8_EDITViewBase();
    virtual ~Receitas_8_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_8_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_8_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_8_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_8_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_8_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_8_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_8_EDITVIEWBASE_HPP
