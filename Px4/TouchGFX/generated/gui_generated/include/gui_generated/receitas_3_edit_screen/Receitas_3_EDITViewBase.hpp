...
/*********************************************************************************/
#ifndef RECEITAS_3_EDITVIEWBASE_HPP
#define RECEITAS_3_EDITVIEWBASE_HPP
...
class Receitas_3_EDITViewBase : public touchgfx::View<Receitas_3_EDITPresenter>
{
public:
    Receitas_3_EDITViewBase();
    virtual ~Receitas_3_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_3_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_3_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_3_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_3_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_3_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_3_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_3_EDITVIEWBASE_HPP
