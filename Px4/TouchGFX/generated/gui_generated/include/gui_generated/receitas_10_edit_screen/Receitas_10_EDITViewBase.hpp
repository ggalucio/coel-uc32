...
/*********************************************************************************/
#ifndef RECEITAS_10_EDITVIEWBASE_HPP
#define RECEITAS_10_EDITVIEWBASE_HPP
...
class Receitas_10_EDITViewBase : public touchgfx::View<Receitas_10_EDITPresenter>
{
public:
    Receitas_10_EDITViewBase();
    virtual ~Receitas_10_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_10_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_10_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_10_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_10_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_10_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_10_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_10_EDITVIEWBASE_HPP
