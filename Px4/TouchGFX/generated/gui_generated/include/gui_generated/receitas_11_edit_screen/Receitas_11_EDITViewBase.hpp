...
/*********************************************************************************/
#ifndef RECEITAS_11_EDITVIEWBASE_HPP
#define RECEITAS_11_EDITVIEWBASE_HPP
...
class Receitas_11_EDITViewBase : public touchgfx::View<Receitas_11_EDITPresenter>
{
public:
    Receitas_11_EDITViewBase();
    virtual ~Receitas_11_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_11_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_11_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_11_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_11_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_11_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_11_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_11_EDITVIEWBASE_HPP
