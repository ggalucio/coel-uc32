...
/*********************************************************************************/
#ifndef RECEITAS_4_EDITVIEWBASE_HPP
#define RECEITAS_4_EDITVIEWBASE_HPP
...
class Receitas_4_EDITViewBase : public touchgfx::View<Receitas_4_EDITPresenter>
{
public:
    Receitas_4_EDITViewBase();
    virtual ~Receitas_4_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_4_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_4_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_4_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_4_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_4_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_4_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_4_EDITVIEWBASE_HPP
