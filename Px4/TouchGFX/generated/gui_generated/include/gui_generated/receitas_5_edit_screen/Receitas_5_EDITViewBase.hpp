...
/*********************************************************************************/
#ifndef RECEITAS_5_EDITVIEWBASE_HPP
#define RECEITAS_5_EDITVIEWBASE_HPP
...
class Receitas_5_EDITViewBase : public touchgfx::View<Receitas_5_EDITPresenter>
{
public:
    Receitas_5_EDITViewBase();
    virtual ~Receitas_5_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_5_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_5_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_5_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_5_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_5_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_5_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_5_EDITVIEWBASE_HPP
