...
/*********************************************************************************/
#ifndef RECEITAS_2_EDITVIEWBASE_HPP
#define RECEITAS_2_EDITVIEWBASE_HPP
...
class Receitas_2_EDITViewBase : public touchgfx::View<Receitas_2_EDITPresenter>
{
public:
    Receitas_2_EDITViewBase();
    virtual ~Receitas_2_EDITViewBase() {}
...
private:
     ...
     */
    touchgfx::Callback<Receitas_2_EDITViewBase, const touchgfx::AbstractButton&> buttonCallback;
    touchgfx::Callback<Receitas_2_EDITViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
    touchgfx::Callback<Receitas_2_EDITViewBase> keyboardContainer21HideKeyboardCallback;
    touchgfx::Callback<Receitas_2_EDITViewBase> numKeyboardContainer1HideKeypadTriggerCallback;
    touchgfx::Callback<Receitas_2_EDITViewBase> numKeyboardContainer1OutOfRangeCallback;
    touchgfx::Callback<Receitas_2_EDITViewBase> numKeyboardContainer1ValidRangeCallback;
...
#endif // RECEITAS_2_EDITVIEWBASE_HPP
