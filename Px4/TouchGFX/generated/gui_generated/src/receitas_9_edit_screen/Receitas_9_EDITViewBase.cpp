...
Receitas_9_EDITViewBase::Receitas_9_EDITViewBase() :
    buttonCallback(this, &Receitas_9_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_9_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_9_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_9_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_9_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_9_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    textArea1_3.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5481));
    ...
    textAreaReceitaXDesc.setPosition(108, 50, 262, 31);
    textAreaReceitaXDesc.setColor(touchgfx::Color::getColorFromRGB(48, 72, 167));
    textAreaReceitaXDesc.setLinespacing(0);
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4957).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4956));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5471));
    ...
    flexButtonReceitaXDesc.setPosition(109, 50, 259, 31);
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4959));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4961).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4960));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4962));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4964).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4963));
...
void Receitas_9_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_9_desc, 20);
    Update(&toggleButtonRXTimeTemp, R9_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_9, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_09 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R9_cong_resf);
    Update(&toggleButtonRXhardSoft, R9_Hard_Soft);
    Update(&toggleButtonRXConservYn, R9_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_9_EDITViewBase::afterTransition()
{
...
void Receitas_9_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_9_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_9_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_9_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_9_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_9_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_9_desc, textAreaReceitaXDescBuffer, 20);
    
    R9_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_9        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_09 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R9_cong_resf           = toggleButtonRXCongResf.getState();
    R9_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R9_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_9_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_9_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
