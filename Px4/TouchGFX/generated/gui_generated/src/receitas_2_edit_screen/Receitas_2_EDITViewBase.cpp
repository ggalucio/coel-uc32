...
Receitas_2_EDITViewBase::Receitas_2_EDITViewBase() :
    buttonCallback(this, &Receitas_2_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_2_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_2_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_2_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_2_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_2_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    textArea1_3.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5475));
    ...
    Unicode::snprintf(textAreaTitleBuffer, TEXTAREATITLE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4524).getText());
    textAreaTitle.setWildcard(textAreaTitleBuffer);
    textAreaTitle.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4253));

    textArea1.setXY(8, 58);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(128, 128, 128));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5486));

    textArea1_1.setXY(8, 93);
    textArea1_1.setColor(touchgfx::Color::getColorFromRGB(128, 128, 128));
    textArea1_1.setLinespacing(0);
    textArea1_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5487));

    textArea1_2.setXY(8, 138);
    textArea1_2.setColor(touchgfx::Color::getColorFromRGB(128, 128, 128));
    textArea1_2.setLinespacing(0);
    textArea1_2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5488));
    ...
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4261).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4260));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5464));
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4263));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4265).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4264));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4266));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4268).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4267));
...
void Receitas_2_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_2_desc, 20);
    Update(&toggleButtonRXTimeTemp, R2_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_2, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_02 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R2_cong_resf);
    Update(&toggleButtonRXhardSoft, R2_Hard_Soft);
    Update(&toggleButtonRXConservYn, R2_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_2_EDITViewBase::afterTransition()
{
...
void Receitas_2_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_2_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_2_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_2_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_2_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_2_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_2_desc, textAreaReceitaXDescBuffer, 20);
    
    R2_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_2        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_02 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R2_cong_resf           = toggleButtonRXCongResf.getState();
    R2_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R2_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_2_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_2_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
