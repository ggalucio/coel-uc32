...
Receitas_8_EDITViewBase::Receitas_8_EDITViewBase() :
    buttonCallback(this, &Receitas_8_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_8_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_8_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_8_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_8_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_8_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    Unicode::snprintf(textAreaTitleBuffer, TEXTAREATITLE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4851).getText());
    textAreaTitle.setWildcard(textAreaTitleBuffer);
    textAreaTitle.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4850));
    ...
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4858).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4857));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5470));
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4860));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4862).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4861));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4863));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4865).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4864));
...
void Receitas_8_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_8_desc, 20);
    Update(&toggleButtonRXTimeTemp, R8_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_8, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_08 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R8_cong_resf);
    Update(&toggleButtonRXhardSoft, R8_Hard_Soft);
    Update(&toggleButtonRXConservYn, R8_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_8_EDITViewBase::afterTransition()
{
...
void Receitas_8_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_8_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_8_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_8_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_8_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_8_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_8_desc, textAreaReceitaXDescBuffer, 20);
    
    R8_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_8        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_08 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R8_cong_resf           = toggleButtonRXCongResf.getState();
    R8_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R8_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_8_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_8_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
