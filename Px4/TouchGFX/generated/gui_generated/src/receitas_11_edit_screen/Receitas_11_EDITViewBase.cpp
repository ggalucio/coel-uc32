...
Receitas_11_EDITViewBase::Receitas_11_EDITViewBase() :
    buttonCallback(this, &Receitas_11_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_11_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_11_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_11_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_11_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_11_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    Unicode::snprintf(textAreaTitleBuffer, TEXTAREATITLE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5148).getText());
    textAreaTitle.setWildcard(textAreaTitleBuffer);
    textAreaTitle.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5147));
    ...
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5155).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5154));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5473));
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5157));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5159).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5158));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5160));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5162).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5161));
...
void Receitas_11_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_11_desc, 20);
    Update(&toggleButtonRXTimeTemp, R11_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_11, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_11 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R11_cong_resf);
    Update(&toggleButtonRXhardSoft, R11_Hard_Soft);
    Update(&toggleButtonRXConservYn, R11_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_11_EDITViewBase::afterTransition()
{
...
void Receitas_11_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_11_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_11_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_11_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_11_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_11_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_11_desc, textAreaReceitaXDescBuffer, 20);
    
    R11_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_11        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_11 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R11_cong_resf           = toggleButtonRXCongResf.getState();
    R11_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R11_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_11_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_11_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
