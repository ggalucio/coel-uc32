...
Receitas_5_EDITViewBase::Receitas_5_EDITViewBase() :
    buttonCallback(this, &Receitas_5_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_5_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_5_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_5_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_5_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_5_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    Unicode::snprintf(textAreaTitleBuffer, TEXTAREATITLE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4554).getText());
    textAreaTitle.setWildcard(textAreaTitleBuffer);
    textAreaTitle.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4553));
    ...
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4561).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4560));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5467));
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4563));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4565).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4564));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4566));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4568).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4567));
...
void Receitas_5_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_5_desc, 20);
    Update(&toggleButtonRXTimeTemp, R5_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_5, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_05 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R5_cong_resf);
    Update(&toggleButtonRXhardSoft, R5_Hard_Soft);
    Update(&toggleButtonRXConservYn, R5_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_5_EDITViewBase::afterTransition()
{
...
void Receitas_5_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_5_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_5_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_5_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_5_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_5_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_5_desc, textAreaReceitaXDescBuffer, 20);
    
    R5_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_5        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_05 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R5_cong_resf           = toggleButtonRXCongResf.getState();
    R5_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R5_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_5_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_5_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
