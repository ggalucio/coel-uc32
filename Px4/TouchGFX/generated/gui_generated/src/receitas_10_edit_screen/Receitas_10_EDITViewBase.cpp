...
Receitas_10_EDITViewBase::Receitas_10_EDITViewBase() :
    buttonCallback(this, &Receitas_10_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_10_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_10_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_10_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_10_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_10_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    Unicode::snprintf(textAreaTitleBuffer, TEXTAREATITLE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5419).getText());
    textAreaTitle.setWildcard(textAreaTitleBuffer);
    textAreaTitle.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5048));

    image1.setXY(8, 4);
    image1.setBitmap(touchgfx::Bitmap(BITMAP_CHAPEU_ID));

    box1.setPosition(107, 49, 262, 31);
    ...
    textAreaReceitaXDesc.setPosition(107, 49, 262, 31);
    textAreaReceitaXDesc.setColor(touchgfx::Color::getColorFromRGB(48, 72, 167));
    textAreaReceitaXDesc.setLinespacing(0);
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5056).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5055));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5472));
    ...
    flexButtonReceitaXDesc.setPosition(108, 49, 259, 31);
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5058));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5060).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5059));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5061));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID5063).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5062));
...
void Receitas_10_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_10_desc, 20);
    Update(&toggleButtonRXTimeTemp, R10_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_10, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_10 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R10_cong_resf);
    Update(&toggleButtonRXhardSoft, R10_Hard_Soft);
    Update(&toggleButtonRXConservYn, R10_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_10_EDITViewBase::afterTransition()
{
...
void Receitas_10_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_10_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_10_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_10_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_10_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_10_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_10_desc, textAreaReceitaXDescBuffer, 20);
    
    R10_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_10        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_10 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R10_cong_resf           = toggleButtonRXCongResf.getState();
    R10_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R10_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_10_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_10_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
