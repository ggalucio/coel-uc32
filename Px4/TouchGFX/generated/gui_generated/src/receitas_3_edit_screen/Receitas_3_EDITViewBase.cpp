...
Receitas_3_EDITViewBase::Receitas_3_EDITViewBase() :
    buttonCallback(this, &Receitas_3_EDITViewBase::buttonCallbackHandler),
    flexButtonCallback(this, &Receitas_3_EDITViewBase::flexButtonCallbackHandler),
    keyboardContainer21HideKeyboardCallback(this, &Receitas_3_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler),
    numKeyboardContainer1HideKeypadTriggerCallback(this, &Receitas_3_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler),
    numKeyboardContainer1OutOfRangeCallback(this, &Receitas_3_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler),
    numKeyboardContainer1ValidRangeCallback(this, &Receitas_3_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler)
{
    ...
    Unicode::snprintf(textAreaTitleBuffer, TEXTAREATITLE_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4525).getText());
    textAreaTitle.setWildcard(textAreaTitleBuffer);
    textAreaTitle.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4352));

    image1.setXY(8, 4);
    image1.setBitmap(touchgfx::Bitmap(BITMAP_CHAPEU_ID));

    box1.setPosition(109, 49, 262, 31);
    ...
    textAreaReceitaXDesc.setPosition(109, 49, 262, 31);
    textAreaReceitaXDesc.setColor(touchgfx::Color::getColorFromRGB(48, 72, 167));
    textAreaReceitaXDesc.setLinespacing(0);
    Unicode::snprintf(textAreaReceitaXDescBuffer, TEXTAREARECEITAXDESC_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4360).getText());
    textAreaReceitaXDesc.setWildcard(textAreaReceitaXDescBuffer);
    textAreaReceitaXDesc.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4359));

    textArea2.setXY(424, 62);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 0, 0));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5465));
    ...
    flexButtonReceitaXDesc.setPosition(110, 49, 259, 31);
    ...
    textArea1_2_1_C.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4362));
    ...
    Unicode::snprintf(textAreaTemperaturaReceitaBuffer, TEXTAREATEMPERATURARECEITA_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4364).getText());
    textAreaTemperaturaReceita.setWildcard(textAreaTemperaturaReceitaBuffer);
    textAreaTemperaturaReceita.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4363));
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4365));
    ...
    Unicode::snprintf(textAreaTempoReceitaXBuffer, TEXTAREATEMPORECEITAX_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID4367).getText());
    textAreaTempoReceitaX.setWildcard(textAreaTempoReceitaXBuffer);
    textAreaTempoReceitaX.setTypedText(touchgfx::TypedText(T_SINGLEUSEID4366));
...
void Receitas_3_EDITViewBase::setupScreen()
{
    ...
    //Execute C++ code
    Update(&textAreaReceitaXDesc, textAreaReceitaXDescBuffer, Receita_3_desc, 20);
    Update(&toggleButtonRXTimeTemp, R3_time_temp);
    Update(&textAreaTempoReceitaX, textAreaTempoReceitaXBuffer, Tempo_receita_3, _DOUBLE_, 0);
    Update(&textAreaTemperaturaReceita, textAreaTemperaturaReceitaBuffer, Temperatura_receita_03 / 10.0, _DOUBLE_, 1);
    Update(&toggleButtonRXCongResf, R3_cong_resf);
    Update(&toggleButtonRXhardSoft, R3_Hard_Soft);
    Update(&toggleButtonRXConservYn, R3_Conserv_yn);

}

//Called when the screen transition ends
void Receitas_3_EDITViewBase::afterTransition()
{
...
void Receitas_3_EDITViewBase::keyboardContainer21HideKeyboardCallbackHandler()
{
    //HideNameKeyboard
...
void Receitas_3_EDITViewBase::numKeyboardContainer1HideKeypadTriggerCallbackHandler()
{
    //HideNumKeyboard
...
void Receitas_3_EDITViewBase::numKeyboardContainer1OutOfRangeCallbackHandler()
{
    //OutOfRangeFIred
...
void Receitas_3_EDITViewBase::numKeyboardContainer1ValidRangeCallbackHandler()
{
    //InsideRangeFired
...
void Receitas_3_EDITViewBase::handleTickEvent()
{
    //HandleTickEvent
...
void Receitas_3_EDITViewBase::tearDownScreen()
{
    //TearDownScreen
    //When tearDownScreen is called execute C++ code
    //Execute C++ code
    CopyTextArea(Receita_3_desc, textAreaReceitaXDescBuffer, 20);
    
    R3_time_temp           = toggleButtonRXTimeTemp.getState();
    Tempo_receita_3        = GetNumberTextArea(textAreaTempoReceitaXBuffer);
    Temperatura_receita_03 = GetNumberTextArea(textAreaTemperaturaReceitaBuffer) * 10.0;
    R3_cong_resf           = toggleButtonRXCongResf.getState();
    R3_Hard_Soft           = toggleButtonRXhardSoft.getState();
    R3_Conserv_yn          = toggleButtonRXConservYn.getState();
...
void Receitas_3_EDITViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void Receitas_3_EDITViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
